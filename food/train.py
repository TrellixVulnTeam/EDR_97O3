...
from food_dataset import Food101N
...
def main(args):
    ...
    trainset = Food101N(root = 'data', split = 'train', transform = transform_train)
    ...
    valset = Food101N(root = 'data', split = 'val', transform = transform_test)
    valloader = torch.utils.data.DataLoader(valset, batch_size = batch_size, shuffle = False, num_workers = num_workers)

    testset = Food101N(root = 'data', split = 'test', transform = transform_test)
